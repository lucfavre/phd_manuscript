...
%Averages
\newcommand{\spavg}[1]{\left< #1 \right>_{2}}
...
\newcommand{\degC}{\degree\mathrm{C}}
...
\newcommand{\erfc}[1]{\mathrm{erfc}\parth{#1}}
\newcommand{\erfcrec}[1]{\mathrm{erfc\textsuperscript{-1}}\parth{#1}}
