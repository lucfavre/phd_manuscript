...
\renewcommand\nomgroup[1]{%
  ...
  \ifstrequal{#1}{M}{Mathematical Conventions}}}}}}%
]}
...
\cleardoublepage\include{FrontBackMatter/Foreword} % Dedication page

\cleardoublepage\include{FrontBackMatter/Abstract} % Abstract page

\cleardoublepage\include{FrontBackMatter/Resume} % Résumé page
...
\include{Chapters/intro_ccl/Intro}


%%PART 1
\part{Modeling and simulation of boiling flows using NEPTUNE\_CFD} % Second part of the thesis

\include{Chapters/NCFD/Chap_NCFD} % Cha pter NCFD
%\include{Chapters/Chapter03} % Chapter 3

\include{Chapters/NCFD/Chap_Debora}


\include{Chapters/NCFD/Chap_Debora_NCFD}
...
\include{Chapters/HFP/Chap_HFPmodels}

\include{Chapters/HFP/Chap_BubDyn}

\include{Chapters/HFP/Chap_Closures}

\include{Chapters/HFP/Chap_NewHFP}  

\include{Chapters/HFP/Chap_ToCHF}
...
\include{Chapters/industrial/Chap_Promoteur}

\include{Chapters/industrial/Chap_Prom_CFD}

\include{Chapters/intro_ccl/Conclusion}
...
%\include{Appendix/App_BubGrowth}
