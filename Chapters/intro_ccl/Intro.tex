...
\begin{note*}{}
In normal PWR conditions, the heat flux at the rods lies rougly between $500~$kW/m\up{2} and 1.5~MW/m\up{2} \cite{pujet_memento_2016}. In accidental conditions, it can rise up to several MW/m\up{2} \cite{manon_contribution_2000}.
\end{note*}
