...
In 1998, Auton \etal \cite{auton_1998} analytically derived the lift force for an inviscid fluid in unstationnary motion in a weak velocity gradient and found $C_{L}=0.5$. Later, Legendre \& Magnaudet (1998) used numerical results to propose a dependency of $C_{L}$ on the bubble Reynolds number for a sphere in an infinite meidum facing a weakly sheared flows as:
