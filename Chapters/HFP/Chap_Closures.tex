...
To estimate the error made over the HTC on Richenderfer, Kossolapov and Jens-Lottes cases, we display on Figure \ref{fig:ncfd_gniel_corr_htc} the predictions of Gnielisnki correlation including a constant correction factor for those cases.
...
\subfloat[Corrected Gnielinski correlation. We multiply the HTC by 3.5 on Richenderfer and Kossolapov cases and by 0.9 on Jens-Lotte cases.]{
...
Corrected Gnielisnki & 2.26 & 2.49 & 1.57 & 1.74 \\
\\
