...
%
R_{c} =& \dfrac{2\sigma\parth{1+\dfrac{\rho_{V}}{\rho_{L}}} / P }{\exp{\dfrac{h_{LV} \Delta T_{w}}{\dfrac{R_{g}}{M} T_{w}T_{sat}} } -1}\\
%
...
\label{eq:nsit_li}\\
%
\mathrm{f}\parth{P} &= 26.006 - 3.678 e^{-2P} - 21.907e^{-P / 24.065}\\
%
...
\caption{Examples of experimental nucleation sites distribution in flow boiling.}
