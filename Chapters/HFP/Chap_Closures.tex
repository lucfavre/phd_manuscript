...
\begin{note*}{}
This formulation is used in Gilman \cite{gilman_phd} and Kommajosyula \cite{kommajosyula_development_2020} HFP models, with their own choice of value for $K$.
\end{note*}
...
\begin{remark*}
This expression, used in Kommajosyula's HFP model, will yield $t_{w}=0$ for saturated boiling conditions, which is hardly reasonable since a non-zero wait time exists between two nucleation events even at saturation \cite{gerardi_ijhmt_2010}.
\end{remark*}
