...
\begin{figure}[!h]
\centering
\subfloat[New model, $P=19.8$ bar]{
\includegraphics[width=0.5\linewidth]{img/HFP/koss/koss_p19_nm.pdf}
}
\subfloat[New model, $P=75.8$ bar]{
\includegraphics[width=0.5\linewidth]{img/HFP/koss/koss_p75_nm.pdf}
}
\\
\subfloat[Kommajosyula model, $P=19.8$ bar]{
\includegraphics[width=0.5\linewidth]{img/HFP/koss/koss_p19_komma.pdf}
}
\subfloat[Kommajosyula model, $P=75.8$ bar]{
\includegraphics[width=0.5\linewidth]{img/HFP/koss/koss_p75_komma.pdf}
}
\\
\subfloat[Kurul \& Podowski model, $P=19.8$ bar]{
\includegraphics[width=0.5\linewidth]{img/HFP/koss/koss_p19_kp.pdf}
}
\subfloat[Kurul \& Podowski model, $P=75.8$ bar]{
\includegraphics[width=0.5\linewidth]{img/HFP/koss/koss_p75_kp.pdf}
}
...
\centering
\subfloat[New model]{
\includegraphics[width=0.5\linewidth]{img/HFP/jens/jens_p138_nm.pdf}
}\\
\subfloat[Kommajosyula model]{
\includegraphics[width=0.5\linewidth]{img/HFP/jens/jens_p138_komma.pdf}
}
\subfloat[Kurul \& Podowski model]{
\includegraphics[width=0.5\linewidth]{img/HFP/jens/jens_p138_kp.pdf}
}
...
Similar to Kossolapov cases (Figure \ref{fig:HFP_koss_BC}),other HFP models provide strikingly different results. While having fair wall temperature predictions, Kommajosyula model predicts a nearly constant liquid convective heat flux before rapidly producing a large evaporation heat flux. On the other hand, Kurul \& Podowski model is still in his single-phase zone with only liquid convection.
