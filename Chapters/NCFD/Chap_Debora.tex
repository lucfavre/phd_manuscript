...
The test section in presented on Figure \ref{fig:sketch_debora}. It consists of an inconel tube with inner diameter $D_{h}=19.2$ mm, a 1 mm thickness and a heated length $L_{heat}$=3.5 m.

A detailed description of the whole experimental loop is given in Garnier \etal \cite{garnier_local_2001}.
...
The local measurements are conducted at the end of the heating length, with a controllable probe that can cover the whole diameter of the test section. 
