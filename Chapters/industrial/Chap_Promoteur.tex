...
%%%%
\centering
\subfloat[Measurement radius. (Adapted from \ref{falk_debprom})]
{
...
\caption{Average relative importance of radial velocity to axial velocity in AGATE experiment. Black dotted lines denotes the position of the MV.}
