...
\draw(0.21,0.77) node{$\redmath{\bm{\times}}$};

\draw(0.28,0.16) node{$\redmath{\bm{\times}}$};
...
\draw(\xmax+0.05, \xmax-0.05) circle(0) node[right]{$\times$ : Active site};
\draw(\xmax+0.05, \xmax-0.15) circle(0) node[right]{$\redmath{\bm{\times}}$ : Deactivated site};
\draw[fill=gray!15!white](\xmax+0.05, \xmax-0.25) circle(0.02) node[right]{ : Nucleating bubble};
\draw[fill=olive!25!white](\xmax+0.05, \xmax-0.35) circle(0.02) node[right]{ : Static coalescence};
